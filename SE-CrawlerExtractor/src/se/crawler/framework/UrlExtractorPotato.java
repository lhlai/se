 ...
 * @date　  2016.6.15
 */
public class UrlExtractorPotato {
	...
	/**
	 * 得到所有http://www.potato.agri.cn/导航页面url
	 * @return   HashSet<String> 所有导航页面url集合
	 */
	public static Set<String> getAllPotatoNavigationLinks() {
		Set<String> nvglinks = null; 
		String src = "urlseeds/agriPotatoSeeds/agriPotatoSeeds.txt";

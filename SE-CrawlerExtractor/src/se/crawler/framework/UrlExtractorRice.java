...
public class UrlExtractorRice {
	...
	/**
	 * 得到所有http://www.rice.agri.cn/导航页面url
	 * @return   HashSet<String> 所有导航页面url集合
	 */
	public static Set<String> getAllRiceNavigationLinks() {
		Set<String> nvglinks = null; 
		String src = "urlseeds/agriRiceSeeds/agriRiceSeeds.txt";
